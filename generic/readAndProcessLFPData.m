...
ExtractedTrialType=TrialType(ordered_matches); %Only keep trial types for the trials we extracted.
ExtractedTrialStamps=ReachTrialStamps(ordered_matches); %Only keep trial stamps for the trials we extracted.
ExtractedStartTime=StartTime(ordered_matches); %Only keep start times for trials we extracted
ExtractedReachTrialIndex=ordered_matches; %The index of Reach Trials for which LFPs exist - unsure if correct or even used
